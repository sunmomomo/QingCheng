...
-(void)layoutSubviews
{
    ...
    _layerView.image =  [image stretchableImageWithLeftCapWidth:20 topCapHeight:0];
...
-(void)layoutSubviews
{
    ...
    _titleLabel.frame = CGRectMake(self.isMine?14:21, 10, size.width, size.height);
    
    _backView.frame = CGRectMake(self.isMine?MSW-58-24-9-2-size.width:58, self.isGroup?_nameLabel.bottom+4:5, size.width+24+9+2,size.height+20);
...
-(void)layoutSubviews
{
    ...
    _backView.frame = CGRectMake(self.isMine?_imageView.left-2:_imageView.left, _imageView.top, _imageView.width+2, _imageView.height);
...
-(void)layoutSubviews
{
    ...
    _backView.frame = CGRectMake(self.isMine?MSW-58-width-2:58, self.isGroup?_nameLabel.bottom+4:5,width+2, 40);
