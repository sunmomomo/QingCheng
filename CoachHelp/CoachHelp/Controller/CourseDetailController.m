...
-(void)editCourse
{
    ...
    if (self.course.gyms.count>1) {
        ...
        [self showAppAlertWithTitle:@"编辑多场馆课程" andSubtitle:nil];
...
-(void)scan
{
    ...
    [self showAppAlertWithTitle:@"编辑课程种类简介" andSubtitle:nil];
...
-(void)coverChange
{
    ...
    if (self.course.gyms.count == 1 && permission.editState) {
        ...
        [self showAppAlertWithTitle:@"编辑封面照片" andSubtitle:nil];
...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (buttonIndex == 0) {
        ...
        if (self.course.gyms.count>1){
            ...
            [self showAppAlertWithTitle:@"课程种类" andSubtitle:@"请在健身房管理App中管理多适用场馆课程"];
            
        }else if(permission.deleteState){
