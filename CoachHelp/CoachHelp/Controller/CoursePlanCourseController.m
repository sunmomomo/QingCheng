...
@interface CoursePlanCourseController ()<MOTableViewDatasource,UITableViewDelegate>
...
-(void)reloadData
{
    ...
    if (courseType == CourseTypeGroup) {
        ...
        [self.info requestGroupDataWithGym:AppGym];
        
    }else{
        
        [self.info requestPrivateDataWithGym:AppGym];
...
-(void)createUI
{
    ...
    self.title = courseType == CourseTypePrivate?@"选择私教种类":@"选择团课种类";
    ...
    [addButton setTitle:courseType == CourseTypePrivate?@"+ 添加私教种类":@"+ 添加团课种类" forState:UIControlStateNormal];
...
-(UIView *)emptyViewForTableView:(MOTableView *)tableView
{
    ...
    emptyLabel.text = courseType == CourseTypePrivate?@"暂无私教种类":@"暂无团课种类";
