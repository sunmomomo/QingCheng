...
@interface QualityMatchEditController ()<UITextFieldDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,QCKeyboardViewDelegate,UIAlertViewDelegate>
...
@implementation QualityMatchEditController
...
-(void)createUI
{
    ...
    self.photoSTF.placeholder = @"有无奖项";
    ...
    self.qualityNameTF.placeholder = @"奖项名称";
    ...
    self.startTF.placeholder = @"奖项生效日期";
...
-(void)confirm:(UIButton*)btn
{
    ...
    if (self.nameTF.text.length&&self.quality.organization.ognId&&self.issueTF.text.length) {
        ...
        [para setParameter:@"3" forKey:@"type"];
