...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _contentLabel = [[UILabel alloc]initWithFrame:CGRectMake(_nameLabel.left, Height(35), MSW-_nameLabel.left-Width(15), Height(50))];
        ...
        _replyContentLabel = [[UILabel alloc]initWithFrame:CGRectMake(Width(10), Height(10), _replyView.width-Width(25), Height(18))];
...
-(void)setContent:(NSString *)content
{
    ...
    [paragraphStyle setLineSpacing:Height320(4)];
    
    CGSize size = [_content boundingRectWithSize:CGSizeMake(_contentLabel.width, MAXFLOAT) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:AllFont(13),NSParagraphStyleAttributeName:paragraphStyle} context:nil].size;
    
    [_contentLabel changeHeight:(long)size.height];
    
    NSAttributedString *astr = [[NSAttributedString alloc]initWithString:_content attributes:@{NSParagraphStyleAttributeName:paragraphStyle}];
...
-(void)setReplyContent:(NSString *)replyContent
{
    ...
    [_replyView changeTop:_contentLabel.bottom+Height(5)];
    ...
    CGSize size = [str boundingRectWithSize:CGSizeMake(_replyContentLabel.width, MAXFLOAT) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:AllFont(12),NSParagraphStyleAttributeName:paragraphStyle} context:nil].size;
    ...
    [_replyContentLabel changeHeight:(long)size.height];
    
    [_replyView changeHeight:_replyContentLabel.height+Height(20)];
