...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demoWithDict:(NSDictionary*)parameter
{

    //订单标题，展示给用户
    NSString *order_name    = parameter[@"name"];
    //订单金额,单位（分）
    NSString *order_price   = parameter[@"price"];
    ...
    [packageParams setObject: parameter[@"orderId"]           forKey:@"out_trade_no"];//商户订单号
    ...
    if ( prePayid != nil) {
        ...
        [signParams setObject: @"wx20160226124520229c7c8edf0039065235"     forKey:@"prepayid"];
