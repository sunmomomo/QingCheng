        ...
        if ([responseDic[@"status"]integerValue] == 200) {
            ...
            [responseDic[@"data"][@"comments"] enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                ...
                if (comment.replyContent.length) {
                    ...
                    CGSize replySize= [comment.replyContent boundingRectWithSize:CGSizeMake(MSW-Width(90), MAXFLOAT) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:AllFont(12),NSParagraphStyleAttributeName:paragraphStyle1} context:nil].size;
                    
                    comment.cellHeight = (long)size.height+Height(35)+Height(15)+Height(5)+Height(15)+MAX((long)replySize.height, Height(18))+Height(20);
