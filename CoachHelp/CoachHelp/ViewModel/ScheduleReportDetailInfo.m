...
#define API @"/api/v2/coaches/%ld/reports/schedules/%ld/"
...
-(void)requestWithReport:(OrderReport *)report result:(RequestCallBack)result
{
    ...
    [MOAFHelp AFGetHost:ROOT bindPath:[NSString stringWithFormat:API,CoachId,(long)report.reportId] param:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
