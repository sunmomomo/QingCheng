...
#define CreateAPI @"/api/v1/coaches/%ld/arrange/batches/"

#define CheckAPI @"/api/v1/coaches/%ld/%@/arrange/check/"

#define ChangeAPI @"/api/v1/coaches/%ld/batches/%ld/"

#define TemplateAPI @"/api/v1/coaches/%ld/%@/arrange/template/"

#define SingleAPI @"/api/v1/coaches/%ld/%@/%ld/"
...
-(void)requestWithBatchId:(NSInteger)batchId
{
    ...
    [MOAFHelp AFGetHost:ROOT bindPath:[NSString stringWithFormat:API,CoachId,(long)batchId] param:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
        ...
        if ([responseDic[@"status"] integerValue] == 200) {
            ...
            for (NSDictionary *dict in responseDic[@"data"][@"batch"][@"rule"]) {
                ...
                if ([dict[@"channel"] isEqualToString:@"CARD"]) {
                    ...
                    pay.costStr = [NSString stringWithFormat:@"%.2f",pay.cost];
...
-(void)createBatch:(CoursePlanBatch *)batch result:(void (^)(BOOL,NSString *))result
{
    ...
    [MOAFHelp AFPostHost:ROOT bindPath:[NSString stringWithFormat:CreateAPI,CoachId] postParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)checkBatch:(CoursePlanBatch *)batch result:(void (^)(BOOL,NSString *))result
{
    ...
    [MOAFHelp AFPostHost:ROOT bindPath:[NSString stringWithFormat:CheckAPI,CoachId,batch.course.type == CourseTypeGroup?@"group":@"private"] postParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)changeBatch:(CoursePlanBatch *)batch result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFPutHost:ROOT bindPath:[NSString stringWithFormat:ChangeAPI,CoachId,(long)batch.batchId] putParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)deleteBatch:(CoursePlanBatch *)batch result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFDeleteHost:ROOT bindPath:[NSString stringWithFormat:ChangeAPI,CoachId,(long)batch.batchId] deleteParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)requestAutoFillInfoWithBatch:(CoursePlanBatch *)batch result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFGetHost:ROOT bindPath:[NSString stringWithFormat:TemplateAPI,CoachId,batch.course.type == CourseTypeGroup?@"group":@"private"] param:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)requestWithPlan:(CoursePlan *)plan result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFGetHost:ROOT bindPath:[NSString stringWithFormat:SingleAPI,CoachId,plan.course.type == CourseTypeGroup?@"schedules":@"timetables",(long)plan.planId] param:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)changePlan:(CoursePlan *)plan result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFPutHost:ROOT bindPath:[NSString stringWithFormat:SingleAPI,CoachId,plan.course.type == CourseTypeGroup?@"schedules":@"timetables",(long)plan.planId] putParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
