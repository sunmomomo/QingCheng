...
#define PrivateAPI @"/api/coaches/%ld/coaches/%ld/batches/"

#define GroupAPI @"/api/coaches/%ld/courses/%ld/batches/"
...
-(void)requestPrivateData
{
    ...
    [MOAFHelp AFGetHost:ROOT bindPath:[NSString stringWithFormat:PrivateAPI,CoachId,(long)self.coach.coachId] param:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)requestGroupData
{
    ...
    [MOAFHelp AFGetHost:ROOT bindPath:[NSString stringWithFormat:GroupAPI,CoachId,(long)self.course.courseId] param:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
