...
#define FOREGROUND_STAR_IMAGE_NAME @"mostar_full"
#define BACKGROUND_STAR_IMAGE_NAME @"mostar_empty"
...
- (UIView *)createStarViewWithImage:(NSString *)imageName {
    ...
    for (NSInteger i = 0; i < self.numberOfStars; i ++)
    {
        ...
        if (_starColor) {
            ...
            imageView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:imageName]imageWithTintColor:_starColor]];
