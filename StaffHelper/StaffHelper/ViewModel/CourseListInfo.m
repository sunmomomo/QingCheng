...
#define API @"/api/v2/staffs/%ld/courses/"

#define ChangeAPI @"/api/v2/staffs/%ld/courses/%ld/"

#define GymAPI @"/api/v2/staffs/%ld/courses/%ld/shops/"

#define PermissionAPI @"/api/v2/staffs/%ld/method/courses/"
...
-(void)deleteCourse:(Course *)course result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFDeleteHost:ROOT bindPath:[NSString stringWithFormat:ChangeAPI,StaffId,(long)course.courseId] deleteParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)editCourse:(Course *)course result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFPutHost:ROOT bindPath:[NSString stringWithFormat:ChangeAPI,StaffId,(long)course.courseId] putParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
...
-(void)changeGymWithCourse:(Course *)course result:(void (^)(BOOL, NSString *))result
{
    ...
    [MOAFHelp AFPutHost:ROOT bindPath:[NSString stringWithFormat:GymAPI,StaffId,(long)course.courseId] putParam:para.data success:^(AFHTTPSessionManager *operation, NSDictionary *responseDic) {
