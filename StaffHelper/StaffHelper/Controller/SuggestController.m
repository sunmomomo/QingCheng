...
-(void)createUI
{
    ...
    UIView *topView = [[UIView alloc]initWithFrame:CGRectMake(0, 64, MSW, Height320(150))];
    
    topView.backgroundColor = [UIColor whiteColor];
    
    [self.view addSubview:topView];
    
    self.emailTF = [[QCTextField alloc]initWithFrame:CGRectMake(Width320(16), 0, MSW-Width320(32), Height320(40))];
    ...
    self.suggestTV = [[MOTextView alloc]initWithFrame:CGRectMake(Width320(16)-5, self.emailTF.bottom, self.emailTF.width+10, topView.height-self.emailTF.height)];
    ...
    UILabel *btnLabel = [[UILabel alloc]initWithFrame:CGRectMake(Width320(16), 0, Width320(100), self.uploadBtn.height)];
    ...
    UIImageView *btnImg = [[UIImageView alloc]initWithFrame:CGRectMake(MSW-Width320(23.5), 0, Width320(7.5), Height320(12))];
    
    btnImg.image = [UIImage imageNamed:@"gray_arrow"];
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(Width320(16), 0, Width320(100), self.photoView.height)];
    ...
    UIImageView *arrow = [[UIImageView alloc]initWithFrame:CGRectMake(MSW-Width320(23.5), 0, Width320(7.5), Height320(12))];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    UIImage *image = [UIImage fixOrientation:[UIImage imageWithData:UIImageJPEGRepresentation([info objectForKey:UIImagePickerControllerOriginalImage], 0.75)]];
