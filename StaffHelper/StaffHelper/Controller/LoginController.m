...
#define kTFTop IPhoneAll(20,20)

#define kTFGap IPhoneAll(18,20)
...
-(void)createUI
{
    ...
    if (self.loginOrRegister == 0) {
        ...
        [self.lineView setRightColor:UIColorFromRGB(0x4e4e4e)];
        
    }else
    {
        
        [self.lineView setLeftColor:UIColorFromRGB(0x4e4e4e)];
    ...
    self.phoneTF = [[CountryChooseTextField alloc]initWithFrame:CGRectMake(Width320(20), kTFTop, MSW-Width320(40), Height320(44))];
    
    self.phoneTF.font = AllFont(16);
    ...
    self.nextBtn.backgroundColor = UIColorFromRGB(0x4e4e4e);
    ...
    self.sexPV = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 39, MSW, 177)];
    ...
    self.registerBtn.backgroundColor = UIColorFromRGB(0x4e4e4e);
...
-(void)login
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.05 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        }else
        {
            ...
            [para setParameter:self.pwdTF.text forKey:@"password"];
...
-(void)registerCheck
{
    ...
    [Login registerWithPara:para.data success:^(NSDictionary *responseDic) {
        
        self.registerBtn.userInteractionEnabled = YES;
        
        [self loginSuccess];
        
    } faliure:^(NSString *errorDesc) {
