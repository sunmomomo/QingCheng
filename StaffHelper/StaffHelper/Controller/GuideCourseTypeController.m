...
-(void)createData
{
    ...
    Course *course = ((AppDelegate*)[UIApplication sharedApplication].delegate).course;
    
    if (!course) {
        
        ((AppDelegate*)[UIApplication sharedApplication].delegate).course = [[Course alloc]init];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.image = [UIImage imageNamed:indexPath.row == 0?@"agent_group":@"agent_private"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.course.type = indexPath.row+1;
    
    self.course.name = nil;
    
    self.course.start = nil;
    
    self.course.end = nil;
    
    [self.course.coursePlans removeAllObjects];
    
    GuideCourseController *svc = [[GuideCourseController alloc]init];
