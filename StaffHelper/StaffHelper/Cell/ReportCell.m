...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _rightLabel = [[UILabel alloc]initWithFrame:CGRectMake(MSW-Width320(92), Height320(13), Width320(80), Height320(16))];
        
        _rightLabel.textColor = UIColorFromRGB(0x666666);
        
        _rightLabel.textAlignment = NSTextAlignmentRight;
        
        _rightLabel.font = AllFont(14);
...
-(void)setUsers:(NSString *)users
{
    ...
    if (_users.length) {
        ...
        _subtitleLabel.text = [NSString stringWithFormat:@"%@-%@  %@  %ld人",_startTime,_endTime,_users,(long)_peopleNum];
...
{
    [_imgView setImage:[UIImage imageNamed:@"checkinStudetail"]];
}
